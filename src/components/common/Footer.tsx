        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-2 lg:col-start-6">
            ...
            <ul className="space-y-3.5">
              {[
                t('platformLinks.intel'), 
                t('platformLinks.mandi'), 
                t('platformLinks.disease'), 
                t('platformLinks.weather'), 
                t('platformLinks.schemes')
              ].map((link, i) => (
                <li key={i}>
          ...
          <motion.div variants={itemVariants} className="lg:col-span-2">
            ...
            <ul className="space-y-3.5">
              {[
                ...
                t('resourcesLinks.guides'), 
                t('resourcesLinks.market'), 
                t('resourcesLinks.success'), 
                t('resourcesLinks.help')
              ].map((link, i) => (
                <li key={i}>
