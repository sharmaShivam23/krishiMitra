...
export default function ThreeBackground() {
  ...
  useEffect(() => {
    ...
    const scene = new THREE.Scene();
    // Set a solid background color to block any underlying website gradients (like yellow)
    scene.background = new THREE.Color(0x06241b);
    scene.fog = new THREE.FogExp2(0x06241b, 0.012);
    ...
    // Set alpha to false so the canvas is fully opaque and hides the website's background
  ...
  // Removed mix-blend-screen and opacity-80 to prevent the parent website's background from showing
