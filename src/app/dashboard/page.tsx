...
//   // Animation configurations properly typed for TypeScript
...
//   // Mock Data for the UI (Simulating API response)
//   const weatherData = { temp: '28°C', condition: 'Partly Cloudy', humidity: '45%', wind: '12 km/h' };
//   const mandiAlerts = [
//     { crop: 'Wheat (Sharbati)', price: '₹2,850/q', trend: 'up', market: 'Meerut APMC' },
//     { crop: 'Sugarcane', price: '₹370/q', trend: 'stable', market: 'Meerut APMC' },
//     { crop: 'Mustard', price: '₹5,100/q', trend: 'down', market: 'Ghaziabad Mandi' },
//   ];
...
//         <div>
//           <h1 className="text-3xl md:text-4xl font-black text-agri-900 tracking-tight">
//             Welcome back, Shivam.
//           </h1>
//           <p className="text-gray-500 mt-2 flex items-center font-medium">
//             <MapPin className="w-4 h-4 mr-1 text-agri-600" /> 
//             Meerut, Uttar Pradesh • System Status: <span className="text-agri-600 ml-1 flex items-center"><span className="w-2 h-2 rounded-full bg-agri-400 mr-1 animate-pulse"></span>Online</span>
//           </p>
//         </div>
//         <Link href="/dashboard/disease-detection" className="hidden md:flex items-center space-x-2 bg-agri-900 text-white px-5 py-2.5 rounded-xl font-bold hover:bg-agri-800 transition shadow-lg shadow-agri-900/20">
...
//         {/* Weather Card */}
//         <motion.div variants={item} className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-3xl p-6 text-white shadow-xl shadow-blue-900/10 relative overflow-hidden">
//           <div className="absolute top-0 right-0 p-4 opacity-20">
//             <CloudSun className="w-32 h-32" />
//           </div>
//           <div className="relative z-10">
//             <div className="flex items-center justify-between mb-4">
//               <h3 className="font-bold text-blue-100">Micro-Climate</h3>
//               <CloudSun className="w-6 h-6 text-blue-200" />
//             </div>
...
//             <div className="flex space-x-4 text-sm font-medium bg-white/10 p-3 rounded-xl backdrop-blur-sm w-max border border-white/20">
//               <div className="flex items-center"><Droplets className="w-4 h-4 mr-1 text-blue-200"/> {weatherData.humidity}</div>
//               <div className="flex items-center"><Wind className="w-4 h-4 mr-1 text-blue-200"/> {weatherData.wind}</div>
//             </div>
//           </div>
//         </motion.div>

//         {/* Active Crop Status */}
//         <motion.div variants={item} className="bg-white rounded-3xl p-6 border border-gray-100 shadow-xl shadow-gray-200/40 col-span-1 md:col-span-2 flex flex-col justify-between">
//           <div className="flex justify-between items-start mb-4">
//             <div>
//               <h3 className="text-lg font-bold text-agri-900">Active Deployment</h3>
//               <p className="text-sm text-gray-500 font-medium">Current cycle intelligence</p>
//             </div>
//             <span className="px-3 py-1 bg-agri-100 text-agri-800 text-xs font-bold rounded-lg border border-agri-400/50">Day 42 of 120</span>
//           </div>
          
//           <div className="flex items-center space-x-6">
//             <div className="w-20 h-20 bg-agri-50 rounded-2xl border border-agri-100 flex items-center justify-center">
//                <Activity className="w-10 h-10 text-agri-600" />
//             </div>
//             <div>
//               <h2 className="text-2xl font-black text-agri-900">Wheat (HD 3086)</h2>
//               <p className="text-agri-600 font-medium mt-1">Health Status: Optimal</p>
//             </div>
//           </div>

//           <div className="mt-6 w-full bg-gray-100 rounded-full h-2.5 mb-2 overflow-hidden">
//             <motion.div 
//               initial={{ width: 0 }} 
//               animate={{ width: '35%' }} 
//               transition={{ duration: 1, delay: 0.5 }}
//               className="bg-agri-600 h-2.5 rounded-full"
//             ></motion.div>
//           </div>
...
//         <motion.div variants={item} className="bg-white rounded-3xl p-6 border border-gray-100 shadow-xl shadow-gray-200/40 flex flex-col h-full">
//           <div className="flex justify-between items-center mb-6">
//             <h3 className="text-lg font-bold text-agri-900">Local APMC Telemetry</h3>
//             <Link href="/dashboard/mandi-prices" className="text-sm font-bold text-agri-600 hover:text-agri-800 flex items-center">
...
//               <div key={idx} className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 border border-gray-100 hover:bg-white hover:shadow-md transition-all">
//                 <div>
//                   <h4 className="font-bold text-agri-900">{alert.crop}</h4>
//                   <p className="text-xs text-gray-500 font-medium">{alert.market}</p>
//                 </div>
//                 <div className="text-right">
//                   <div className="font-black text-agri-900">{alert.price}</div>
//                   <div className={`text-xs font-bold flex items-center justify-end mt-0.5 ${
//                     alert.trend === 'up' ? 'text-green-600' : alert.trend === 'down' ? 'text-red-500' : 'text-gray-500'
//                   }`}>
//                     {alert.trend === 'up' && <TrendingUp className="w-3 h-3 mr-1" />}
//                     {alert.trend === 'down' && <TrendingUp className="w-3 h-3 mr-1 rotate-180" />}
//                     {alert.trend === 'stable' && <span className="w-2 h-2 rounded-full bg-gray-400 mr-1"></span>}
//                     {alert.trend.toUpperCase()}
//                   </div>
//                 </div>
//               </div>
//             ))}
...
//         <motion.div variants={item} className="bg-agri-900 rounded-3xl p-6 text-white shadow-xl shadow-agri-900/20 flex flex-col justify-between relative overflow-hidden h-full">
//           <div className="absolute -right-10 -bottom-10 w-48 h-48 bg-agri-600 rounded-full filter blur-[80px] opacity-50"></div>
          
//           <div className="relative z-10 flex-1">
//             <div className="flex items-center space-x-2 mb-2">
//               <ShieldCheck className="w-6 h-6 text-agri-400" />
//               <h3 className="text-lg font-bold">Krishi AI Assistant</h3>
//             </div>
//             <p className="text-agri-100/70 text-sm font-medium mb-6">Your fields are currently protected. Run a scan to analyze new foliage.</p>
            
//             <div className="space-y-3">
//               <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-4 flex items-start space-x-3">
//                 <div className="bg-agri-400/20 p-2 rounded-lg mt-0.5">
//                   <Activity className="w-4 h-4 text-agri-400" />
//                 </div>
//                 <div>
//                   <h4 className="text-sm font-bold text-white">Fertilizer Warning</h4>
//                   <p className="text-xs text-agri-100/70 mt-1">High humidity expected tomorrow. Delay urea application to prevent runoff.</p>
//                 </div>
//               </div>
//             </div>
//           </div>

//           <button className="relative z-10 mt-6 w-full bg-agri-400 text-agri-900 font-bold py-3.5 rounded-xl hover:bg-white transition-colors shadow-[0_0_20px_-5px_rgba(52,211,153,0.4)] flex justify-center items-center">
//             Acknowledge Alerts
//           </button>
//         </motion.div>
//       </div>
