  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-8 overflow-x-hidden max-w-7xl mx-auto">
      ...
      <motion.div variants={item} className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-2 flex items-center font-medium">
            ...
            {locationName} • {t('systemStatus')}: <span className="text-emerald-600 ml-1 flex items-center"><span className="w-2 h-2 rounded-full bg-emerald-400 mr-1 animate-pulse"></span>{t('online')}</span>
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Weather Card */}
        <motion.div variants={item} className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-[2rem] p-6 text-white shadow-xl">
        ...
        {/* Active Crop Status */}
        <motion.div variants={item} className="bg-white rounded-[2rem] p-6 border border-gray-100 shadow-xl col-span-1 md:col-span-2 flex flex-col justify-between overflow-hidden">
          <div className="relative z-10 flex justify-between items-start mb-4">
            <div>
              <h3 className="text-lg font-bold text-emerald-900">{t('deployment.title')}</h3>
              <p className="text-sm text-gray-500 font-medium">{t('deployment.subtitle')}</p>
            </div>
          ...
          <div className="relative z-10 flex items-center space-x-6 my-2">
            ...
            <div>
              <h2 className="text-2xl font-black text-emerald-900">{t('deployment.cropName')}</h2>
          ...
          <div className="relative z-10 mt-auto">
            ...
            <p className="text-xs text-gray-400 font-bold text-right uppercase tracking-wider">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Mandi Tracker */}
        <motion.div variants={item} className="bg-white rounded-[2rem] p-6 border border-gray-100 shadow-xl">
        ...
        {/* Intelligence Panel */}
        <motion.div variants={item} className="bg-emerald-950 rounded-[2rem] p-6 text-white shadow-xl relative overflow-hidden">
