...
//   return (
//     <div className="min-h-screen bg-white flex font-sans selection:bg-emerald-400 selection:text-emerald-950 overflow-hidden">
      
//       {/* LEFT SIDE: Form Section */}
//       <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:flex-none lg:w-[45%] lg:px-20 xl:px-24 relative z-10 bg-white shadow-2xl shadow-emerald-900/5">
//         <motion.div 
...
//               <div className="bg-gradient-to-br from-emerald-500 to-teal-600 p-2 rounded-xl shadow-md group-hover:scale-105 transition-transform">
...
//             <h2 className="text-3xl font-black text-gray-900 tracking-tight">Initialize Workspace</h2>
...
//                   className="p-3 rounded-xl bg-red-50 text-red-700 text-sm border border-red-100 font-bold flex items-center"
//                 >
//                   <ShieldCheck className="w-4 h-4 mr-2 text-red-500 flex-shrink-0" />
//                   {error}
//                 </motion.div>
//               )}
//             </AnimatePresence>
...
//                   className="block w-full pl-11 pr-4 py-3.5 border border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent font-medium transition-all bg-gray-50 hover:bg-white text-gray-900"
...
//             <div>
//               <label htmlFor="state" className="block text-sm font-bold text-gray-700 mb-1.5">Primary Region</label>
//               <div className="relative">
//                 <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
//                   <MapPin className="h-5 w-5 text-gray-400" />
//                 </div>
//                 <select id="state" name="state" required value={formData.state} onChange={handleChange}
//                   className="block w-full pl-11 pr-10 py-3.5 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent font-bold transition-all bg-gray-50 hover:bg-white text-gray-900 appearance-none cursor-pointer"
//                 >
//                   <option value="" disabled className="font-normal text-gray-400">Select operating state</option>
//                   {['Uttar Pradesh', 'Punjab', 'Haryana', 'Maharashtra', 'Gujarat', 'Rajasthan', 'Madhya Pradesh'].map(state => (
...
//             <div>
//               <label htmlFor="password" className="block text-sm font-bold text-gray-700 mb-1.5">Security Key (Password)</label>
//               <div className="relative">
//                 <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
...
//               className="w-full flex justify-center items-center py-4 px-4 rounded-xl shadow-lg shadow-emerald-600/30 text-base font-bold text-white bg-emerald-600 hover:bg-emerald-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-600 transition-all disabled:opacity-70 active:scale-[0.98] mt-2 group"
//             >
//               {loading ? (
//                 <><Loader2 className="w-5 h-5 mr-2 animate-spin" /> Provisioning...</>
//               ) : (
//                 <>Deploy Terminal <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" /></>
//               )}
//             </button>
            
//             <p className="text-center text-xs text-gray-400 font-medium mt-6">
//               By deploying, you agree to our <a href="#" className="text-emerald-600 hover:underline">Terms of Service</a> and <a href="#" className="text-emerald-600 hover:underline">Privacy Policy</a>.
//             </p>
//           </form>
//         </motion.div>
//       </div>
...
//       <div className="hidden lg:flex flex-1 relative bg-slate-950 items-center justify-center p-12">
//         {/* Background Effects */}
//         <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-[0.03]"></div>
//         <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-emerald-600/30 rounded-full mix-blend-screen filter blur-[120px] animate-pulse"></div>
//         <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-teal-500/20 rounded-full mix-blend-screen filter blur-[100px]"></div>
...
//               Enterprise <br/> <span className="text-emerald-400">Crop Intelligence</span> <br/> at your fingertips.
//             </h3>
            
//             <ul className="space-y-4 mb-8">
//               {[
//                 'Predictive ML yield optimization',
//                 'Real-time APMC Mandi telemetry',
//                 'Automated disease detection via CV',
//                 'Centralized government scheme matching'
//               ].map((text, i) => (
...
//             <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl flex items-center">
//               <div className="flex -space-x-3 mr-4">
//                 {[1,2,3].map(i => (
//                   <div key={i} className="w-10 h-10 rounded-full border-2 border-slate-900 bg-slate-800 flex items-center justify-center overflow-hidden">
//                      <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${i+20}&backgroundColor=b6e3f4`} alt="user" className="w-full h-full object-cover" />
//                   </div>
//                 ))}
//               </div>
//               <div>
//                 <p className="text-white font-bold text-sm">Join 10,000+ Farmers</p>
//                 <p className="text-emerald-400 text-xs font-medium">Scaling their harvest today</p>
//               </div>
//             </div>
//           </div>
//         </motion.div>
